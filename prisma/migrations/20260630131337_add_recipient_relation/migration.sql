...
INSERT INTO "new_Transaction" ("amount", "assetType", "cotp", "createdAt", "fee", "id", "methodId", "note", "recipientId", "status", "type", "updatedAt", "userId") SELECT "amount", "assetType", "cotp", "createdAt", "fee", "id", "methodId", "note", "recipientId", "status", "type", "updatedAt", "userId" FROM "Transaction";
